...
def main(x: Output[QNum], y: Output[QNum], res: Output[QNum]):
    ...
    # For 2-qubit number: 0=|00⟩, 1=|01⟩, 2=|10⟩, 3=|11⟩
    # We want equal superposition of 0 and 2, so probabilities: [0.5, 0, 0.5, 0]
    prepare_state([0.5, 0, 0.5, 0], 0.0, x)
    
    # Initialize y to equal superposition of 1, 2, 3, and 6
    # For 3-qubit number: 0=|000⟩, 1=|001⟩, 2=|010⟩, 3=|011⟩, 4=|100⟩, 5=|101⟩, 6=|110⟩, 7=|111⟩
    # We want equal superposition of 1, 2, 3, and 6, so probabilities: [0, 0.5, 0.5, 0.5, 0, 0, 0.5, 0]
